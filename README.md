...
2. Fill in your mailbox account, secret, sender, recipient, subject, and body.
...
EMAIL_SUBJECT=SMTP demo
EMAIL_BODY=Hello, this is a test email sent by the SMTP demo.
```
